...
const CUSTOM_ASSET_FOLDERS = [
  ...
  const WEAPON_SOUND_ALIASES = {
    ...
    rail: ["rail", "rail_1", "rail_2", "hopper_minecart"],
    boat: ["boat", "boat_1", "boat_2", "boat_3", "boat_4"],
    ...
    expBottle: ["experience_bottle"],
    totem: ["totem_of_undying"],
    hopperMinecart: ["hopper_minecart", "rail", "rail_1", "rail_2"],
    tnt: ["tnt"],
    slimePiston: ["slime", "slime_1", "slime_2"],
    observer: ["observer", "observer_1", "observer_2", "observer_3"],
    beehive: ["beehive", "beehive_1", "beehive_2", "beehive_3", "beehive_4"],
    ...
    cryingObsidian: ["crying_obsidian", "crying_obsidian_1", "crying_obsidian_2", "crying_obsidian_3"],
    blazeRod: ["blaze_rod", "blaze_rod_1", "blaze_rod_2", "blaze_rod_3", "blaze_rod_4"],
    rottenFlesh: ["rotten_flesh", "rotten_flesh_1", "rotten_flesh_2", "rotten_flesh_3"],
    jackOLantern: ["jack_o_lantern", "jack_o_lantern_1", "jack_o_lantern_2"],
    boneMeal: ["bone_meal", "bone_meal_1", "bone_meal_2", "bone_meal_3", "bone_meal_4"],
    bookQuill: ["written_book", "written_book_1", "written_book_2", "written_book_3"],
    elytra: ["elytra"],
    goldenApple: ["golden_apple", "golden_apple_1", "golden_apple_2", "golden_apple_3"],
    invisPotion: ["invisibility", "invisibility_1", "invisibility_2", "invisibility_3", "invisibility_4"],
    gravityPotion: ["gravity"],
    turtlePotion: ["turtle_scute"],
  };
...
downloadBattleRecording() {
    ...
    simulateBattle(leftWeaponId, rightWeaponId, options = {}) {
      this.setupBattle(leftWeaponId, rightWeaponId, { countdown: false, hideMenu: false });
